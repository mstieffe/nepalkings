...
class CollectionScreen(MenuScreenMixin, Screen):
    """Placeholder collection screen — card grid will be added in a later phase."""
    ...
    def __init__(self, state):
        ...
        self._title_surf = self._title_font.render('Collection', True, settings.GAME_MENU_TITLE_CLR)
