...
class ConquerRoundLedger:
    ...
    def _draw_round_card(self, rect: pygame.Rect, idx: int,
        ...
        self._draw_player_chip(you_rect, you, is_player_self=True)
    ...
    def _draw_player_chip(self, rect: pygame.Rect, move, is_player_self: bool):
        ...
        ns = name_font.render(name[:14], True, _TEXT_SECONDARY)
        ps = pwr_font.render(str(self._power(move)), True, _TEXT_PRIMARY)
