...
INFO_SCROLL_X = int(0.004 * SCREEN_WIDTH)
INFO_SCROLL_Y = int(0.33 * SCREEN_HEIGHT)

INFO_SCROLL_WIDTH = int(0.12 * SCREEN_WIDTH)
INFO_SCROLL_HEIGHT = int(0.33 * SCREEN_HEIGHT)
...
INFO_SCROLL_Y_TITLE_MARGIN = int(0.06 * SCREEN_HEIGHT)
...
SCOREBOARD_CELL_VALUE_OFFSET = int(0.014 * SCREEN_HEIGHT)      # push value center downward in top-row cells
SCOREBOARD_CELL_SUBTITLE_SPACING = int(0.013 * SCREEN_HEIGHT)  # title-to-value gap (fits subtitle)
SCOREBOARD_SUBTITLE_FONT_SIZE = int(0.012 * SCREEN_HEIGHT)     # subtitle font (e.g. "(build-up)")
