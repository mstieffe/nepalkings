...
SCOREBOARD_CELL_VALUE_OFFSET = int(0.014 * SCREEN_HEIGHT * _UI_SCALE)   # push value center downward in top-row cells
SCOREBOARD_CELL_SUBTITLE_SPACING = int(0.013 * SCREEN_HEIGHT * _UI_SCALE) # title-to-value gap (fits subtitle)
