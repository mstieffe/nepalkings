...
SCOREBOARD_SCROLL_WIDTH = int(0.11 * SCREEN_WIDTH * _UI_SCALE) if _UI_SCALE > 1.0 else int(0.11 * SCREEN_WIDTH)
SCOREBOARD_SCROLL_HEIGHT = int(0.14 * SCREEN_HEIGHT * _UI_SCALE) if _UI_SCALE > 1.0 else int(0.14 * SCREEN_HEIGHT)
...
SCOREBOARD_SCROLL_FONT_SIZE = int(0.02 * _FS)
SCOREBOARD_SCROLL_FONT_TITLE_SIZE = int(0.025 * SCREEN_HEIGHT)
SCOREBOARD_SCROLL_NUMBER_FONT_SIZE = int(0.04 * _FS)
...
SCOREBOARD_CELL_VALUE_OFFSET = int(0.010 * SCREEN_HEIGHT * _UI_SCALE)   # push value center downward in top-row cells
SCOREBOARD_CELL_SUBTITLE_SPACING = int(0.010 * SCREEN_HEIGHT * _UI_SCALE) # title-to-value gap (fits subtitle)
