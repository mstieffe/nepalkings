...
TUTORIAL_BUTTON_Y = int(0.15 * SCREEN_HEIGHT)

LETTER_BUTTON_X = int(0.96 * SCREEN_WIDTH)
LETTER_BUTTON_Y = int(0.27 * SCREEN_HEIGHT)

FIELD_BUTTON_X = int(0.96 * SCREEN_WIDTH)
FIELD_BUTTON_Y = int(0.39 * SCREEN_HEIGHT)

BATTLE_BUTTON_X = int(0.96 * SCREEN_WIDTH)
BATTLE_BUTTON_Y = int(0.51 * SCREEN_HEIGHT)

BATTLE_SHOP_BUTTON_X = int(0.96 * SCREEN_WIDTH)
BATTLE_SHOP_BUTTON_Y = int(0.63 * SCREEN_HEIGHT)
