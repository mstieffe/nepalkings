...
TUTORIAL_BUTTON_Y = int(0.18 * SCREEN_HEIGHT)

LETTER_BUTTON_X = int(0.96 * SCREEN_WIDTH)
LETTER_BUTTON_Y = int(0.34 * SCREEN_HEIGHT)

FIELD_BUTTON_X = int(0.96 * SCREEN_WIDTH)
FIELD_BUTTON_Y = int(0.50 * SCREEN_HEIGHT)

BATTLE_BUTTON_X = int(0.96 * SCREEN_WIDTH)
BATTLE_BUTTON_Y = int(0.66 * SCREEN_HEIGHT)
