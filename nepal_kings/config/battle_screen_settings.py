...
_BPIM = 1.15 if _UI_SCALE > 1.0 else 1.0   # enlarge battle-panel move icons on mobile
...
ROUNDS_LABEL_FONT_SIZE = int(0.022 * _FS)
...
# ────────────────── TURN INDICATOR ────────────────────────────
TURN_INDICATOR_FONT_SIZE = int(0.020 * _FS)
