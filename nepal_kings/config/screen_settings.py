...
SUB_SCREEN_BUTTON_TEXT_COLOR_ACTIVE = (252, 252, 121)  # Bright yellow for active state
SUB_SCREEN_BUTTON_TEXT_COLOR_PASSIVE = (180, 220, 235)  # Light cyan for dark turkis background
