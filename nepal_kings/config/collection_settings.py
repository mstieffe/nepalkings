...
from config.font_settings import FS_BODY, FS_HEADING, FS_SMALL, FS_SUBTITLE
...
# ── Badge overlay ───────────────────────────────────────────────────
COLLECTION_BADGE_FONT_SIZE = FS_SMALL if _IS_MOBILE else int(FS_BODY * 0.75)
...
COLLECTION_STATS_FONT_SIZE = FS_SMALL if _IS_MOBILE else int(FS_BODY * 0.82)
...
COLLECTION_PACK_PANEL_DETAIL_FONT_SIZE = FS_SMALL if _IS_MOBILE else int(FS_BODY * 0.72)
...
COLLECTION_TRADE_TARGET_FONT_SIZE = FS_SMALL if _IS_MOBILE else int(FS_BODY * 0.85)
...
COLLECTION_REVEAL_TIER_LABEL_FONT_SIZE = FS_SMALL if _IS_MOBILE else int(FS_BODY * 0.82)
