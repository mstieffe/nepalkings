...
# Main Screen
MAIN_SCREEN_X = int(0.15 * SCREEN_WIDTH)
MAIN_SCREEN_Y = int(0.15 * SCREEN_HEIGHT)
...
FIGURE_ICON_MASK_BIG_WIDTH = int(0.08 * SCREEN_WIDTH)
FIGURE_ICON_MASK_BIG_HEIGHT = int(0.08 * SCREEN_WIDTH)
...
FIGURE_ICON_GLOW_WIDTH = int(0.10 * SCREEN_WIDTH)
FIGURE_ICON_GLOW_BIG_WIDTH = int(0.12 * SCREEN_WIDTH)
FIGURE_ICON_DELTA_X = int(0.08 * SCREEN_WIDTH)


# BUILD
BUILD_FIGURE_BACKGROUND_IMG_PATH = 'img/background/wood_and_paper.png'
BUILD_FIGURE_BACKGROUND_IMG_WIDTH = int(0.6 * SCREEN_WIDTH)
BUILD_FIGURE_BACKGROUND_IMG_HEIGHT = int(0.6 * SCREEN_HEIGHT)
