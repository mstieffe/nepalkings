...
from game_service.conquer_outcome_recording import record_conquer_outcome
...
def _resolve_conquer_battle(game, winner, requesting_player):
    ...
    _, attacker_first_conquest = record_conquer_outcome(
        game,
        land,
        attacker_user,
        defender_user,
        ...
        deleted_kingdom_id=deleted_kingdom_id,
        deleted_kingdom_name=deleted_kingdom_name,
        loot_gained_cards=loot_gained_cards,
        lost_kingdom_id=lost_kingdom_id,
        create_kingdom_loot_events=_create_kingdom_loot_events,
        now=_utcnow,
        logger=logger,
    )
...
def _serialize_finished_conquer_result(game, viewer_user_id=None):
    ...
    if viewer_user_id is None:
        try:
            ...
            viewer_user_id = None
    return _serialize_finished_conquer_result_impl(
        game,
        viewer_user_id=viewer_user_id,
        serialize_game_for_viewer=serialize_game_for_viewer,
        serialize_viewer_onboarding=_serialize_viewer_onboarding,
        conquer_attacker_player=_conquer_attacker_player,
        conquer_original_defender_player=_conquer_original_defender_player,
    )
